...
def order_list(request):
    ...
    return render(
        ...
        {"orders": orders, "STATUSES_ORDERS": Order.STATUSES_ORDERS},
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if response.status_code == 201:
                ...
                form.add_error(
                    None,
                    f"Order create error: {response.status_code} - {response.text}",
                )
                return render(
                    request, "cafe_main/order_create.html", {"form": form}
...
def revenue(request):
    ...
    try:
        ...
        return render(
            request, "cafe_main/revenue.html", {"total_revenue": total_revenue}
        )
    except requests.exceptions.RequestException as e:
